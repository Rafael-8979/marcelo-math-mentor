...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      {/* Scroll Indicator */}
      <div className="absolute bottom-2 left-1/2 transform -translate-x-1/2 z-20 text-white animate-bounce">
        <div className="w-8 h-12 border-2 border-white/90 rounded-full flex justify-center items-start backdrop-blur-md bg-white/20 shadow-lg">
